                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <a href="#" onclick="editar(
                                                    ...
                                                    '<?php echo $cpf ?>', 
                                                    '<?php echo $telefone ?>', 
                                                    '<?php echo $endereco ?>')" title="Editar Registro"><i class="dw dw-edit2" data-color="#265ed7"></i></a>
                                            ...
                                            <a href="#" onclick="dados(
                                                    ...
                                                    '<?php echo $cpf ?>', 
                                                    '<?php echo $telefone ?>', 
                                                    '<?php echo $endereco ?>')" title="Ver Registro"><text-info class="icon-copy bi bi-info-circle text-info"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
...
<script type="text/javascript">
    function editar(id, nome, email, cpf, telefone, endereco) {
        $('#id').val(id);
        $('#nome').val(nome);
        $('#email').val(email);
        $('#cpf').val(cpf);
    ...
    function dados(nome, email, cpf, telefone, endereco) {
